...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start https://github.com/stan0ne/massgrave & start %mas%/idm-activation-script & exit /b)
)
)
...
if %_erl%==6 exit /b
if %_erl%==5 start https://github.com/stan0ne/massgrave & start https://savasboluk.com/idm & goto MainMenu
